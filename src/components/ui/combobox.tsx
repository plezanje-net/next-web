      ...
      >
        ...
        {options.length > 0 && (
          <ComboboxOptions
            modal={false}
            anchor="bottom start"
            className="[--anchor-gap:9px] min-w-[calc(var(--input-width)+40px)] overflow-hidden rounded-lg border border-neutral-400 bg-white focus-visible:outline-none focus-visible:ring focus-visible:ring-blue-100 z-10"
          >
