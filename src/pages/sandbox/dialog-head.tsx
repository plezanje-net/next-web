...
import DialogHead, { DialogSize } from "../../components/ui/dialog-head";
import IconFilter from "../../components/ui/icons/filter";
import Link from "../../components/ui/link";

function DialogHeadPage() {
      ...
      <div className="mt-16">
        ...
        <div className="pl-4">
          <ul className="mt-2 list-outside list-disc">
            <li>
              Dialog with a lot of text gets scrolled to the bottom where the
              first focusable element is. Expected would be to keep focus at the
              top. With Radix this works out of the box.
            </li>
            <li>
              When disabling closing the dialog with clicking outside of it the
              buttons lose focus. Expected would probably be that the buttons
              keep focus even if you click outside. With Radix this works ootb.
            </li>
          </ul>
        </div>
      </div>
