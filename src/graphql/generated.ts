...
export type AllCragsQuery = { __typename?: 'Query', crags: Array<{ __typename?: 'Crag', id: string, slug: string, name: string, country: { __typename?: 'Country', id: string, name: string, slug: string }, area?: { __typename?: 'Area', id: string, name: string, slug: string, country: { __typename?: 'Country', slug: string } } | null }> };

export type AllCountriesQueryVariables = Exact<{ [key: string]: never; }>;


export type AllCountriesQuery = { __typename?: 'Query', countries: Array<{ __typename?: 'Country', name: string, slug: string, areas: Array<{ __typename?: 'Area', name: string, slug: string }> }> };
