...
export type EditSectorsPageCragQuery = { __typename?: 'Query', cragBySlug: { __typename?: 'Crag', id: string, slug: string, name: string, sectors: Array<{ __typename: 'Sector', id: string, name: string, label: string, position: number, publishStatus: string, user?: { __typename?: 'User', id: string, fullName: string } | null, routes: Array<{ __typename?: 'Route', id: string }>, crag: { __typename?: 'Crag', id: string, publishStatus: string } }> } };
