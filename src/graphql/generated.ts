...
export type EditRoutesPageSectorQuery = { __typename?: 'Query', sector: { __typename?: 'Sector', id: string, label: string, name: string, crag: { __typename?: 'Crag', id: string, slug: string, name: string }, routes: Array<{ __typename?: 'Route', id: string, name: string, difficulty?: number | null, length?: number | null, defaultGradingSystem: { __typename?: 'GradingSystem', id: string, name: string }, routeType: { __typename?: 'RouteType', name: string } }> } };
