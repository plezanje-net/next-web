...
export type Mutation = {
  ...
  deleteRoutes: Scalars['Boolean']['output'];
...
export type EditRoutesPageSectorQuery = { __typename?: 'Query', sector: { __typename?: 'Sector', id: string, label: string, name: string, crag: { __typename?: 'Crag', id: string, slug: string, name: string, sectors: Array<{ __typename?: 'Sector', id: string, label: string, name: string }> }, routes: Array<{ __typename?: 'Route', id: string, name: string, difficulty?: number | null, length?: number | null, position: number, routeType: { __typename?: 'RouteType', id: string }, defaultGradingSystem: { __typename?: 'GradingSystem', id: string } }> } };
...
export type DeleteRoutesMutation = { __typename?: 'Mutation', deleteRoutes: boolean };
