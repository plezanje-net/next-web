...
export type GradingSystemsQueryVariables = Exact<{ [key: string]: never; }>;


export type GradingSystemsQuery = { __typename?: 'Query', gradingSystems: Array<{ __typename?: 'GradingSystem', id: string, name: string, grades: Array<{ __typename?: 'Grade', id: string, name: string, difficulty: number }>, routeTypes: Array<{ __typename?: 'RouteType', id: string, name: string }> }> };
...
export type CragSectorsQuery = { __typename?: 'Query', cragBySlug: { __typename?: 'Crag', id: string, slug: string, sectors: Array<{ __typename?: 'Sector', id: string, name: string, label: string, publishStatus: string, bouldersOnly: boolean, routes: Array<{ __typename?: 'Route', id: string, name: string, slug: string, difficulty?: number | null, isProject: boolean, length?: number | null, nrTicks: number, nrTries: number, nrClimbers: number, position: number, starRating?: number | null, publishStatus: string, defaultGradingSystem: { __typename?: 'GradingSystem', id: string }, routeType: { __typename?: 'RouteType', id: string }, comments: Array<{ __typename?: 'Comment', id: string }>, pitches: Array<{ __typename?: 'Pitch', id: string, difficulty?: number | null, isProject: boolean, number: number, height?: number | null }> }> }> } };
